...
function Imagen() {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-[400px] bg-cover bg-center" style={{ backgroundImage: `url(${imagenUrl})`, zIndex: 1, marginTop: '73px' }}>
        <div className='flex flex-col justify-center items-center mb-[30px]'>
            <h1 className="text-white text-4xl font-bold animate-bounce">¡Pedí lo que quieras!</h1>
