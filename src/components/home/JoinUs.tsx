...
function JoinUs(props: any) {
	...
	return (
		<Link href={linkPath}>
			<div className="w-full md:max-w-md bg-white border border-gray-300 rounded shadow-md dark:bg-gray-800 dark:border-gray-700">
				<div className="relative overflow-hidden h-52">
					<img className="w-full h-full object-cover" src={imageUrl} alt="" />
				</div>
				<div className="m-4 text-xl font-semibold text-gray-900 dark:text-white">
					{paragraphText}
				</div>
				<div className="m-4 flex items-center transition-transform transform hover:scale-105">
