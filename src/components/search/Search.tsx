	...
	return (
		<>
			<div className="fixed z-10 w-full bg-white h-16 flex items-center justify-between px-10 border-b border-gray-300">
				<BackButton />
				<p className="text-black px-4 py-2 font-semibold">Pedidos Crombie</p>
			...
			<div className="flex items-center justify-center bg-white h-[100%] p-10 pt-20" id="sellers">
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-4 md:px-24">
								{searchTerm === ""
									? filteredLocalProfiles
											...
											.map((local) => <LocalCard local={local} key={local.id} />)
