    ...
    return (
      <>
        <Link href={'/sellers/'+local.id}>
          <div className="p-2 max-w-sm bg-white dark:bg-gray-800 dark:border-gray-700 transform transition-all duration-300 hover:scale-105">
            <img className="w-full h-32 object-cover object-center rounded-lg" src={local.logo} alt="" />
