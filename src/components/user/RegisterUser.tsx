...
function RegisterUser() {
  ...
  const imagenUrl =
    "https://plus.unsplash.com/premium_photo-1661274039013-6cfd357c6ee2?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
    ...
    <div className="flex flex-row justify-center items-center w-full h-full bg-cover bg-white">
      ...
      >
        <h1 className="text-white text-7xl font-bold">
          ¡Regístrate hoy y recibe hasta 15 días
        </h1>
